...
public class Arm extends SubsystemBase {
    ...
    public Double getAbsoluteAdjustedPosition() {
        return leftMotor.getAbsoluteEncoder().getPosition() - 101;
    }
}
//the aboslute encoder thing(last like of coding) is occasionally the problem if the note isnt going in the target(dont change to drasticly because might break robot)