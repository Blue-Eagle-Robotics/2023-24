...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        SmartDashboard.putNumber("Launcher set velocity", 4500); // TODO: SET TO 4500 BEFORE COMPETITION 
        SmartDashboard.putNumber("targetHeight",70); // 84
        ...
        s_Swerve.setDefaultCommand(
            new TeleopSwerve(
                s_Swerve,
                s_ApriltagCamera,
                () -> -driver.getRawAxis(translationAxis) * driver.getRawAxis(speedAxis) * SmartDashboard.getNumber("SpeedLimit", 1)  , // TODO: REMOVE BEFORE COMPETITION
                () -> -driver.getRawAxis(strafeAxis) * driver.getRawAxis(speedAxis) * SmartDashboard.getNumber("SpeedLimit", 1) , // TODO: REMOVE BEFORE COMPETITION
                () -> -driver.getRawAxis(rotationAxis) * 0.60 * SmartDashboard.getNumber("SpeedLimit", 1)  , // TODO: REMOVE BEFORE COMPETITION
        ...
        s_Arm.setDefaultCommand(
            new TeleopArm(
                s_Arm,
                () -> -operator.getRawAxis(armAxis) * 0.4 // TODO: REMOVE BEFORE COMPETITION
            )
        );
    ...
    private void configureButtonBindings() {
        ...
        driverIntake.whileTrue(new TeleopIntake(s_Intake, () -> 4000 , true));
